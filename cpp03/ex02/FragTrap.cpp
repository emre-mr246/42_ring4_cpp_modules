...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/13 10:11:53 by emgul             #+#    #+#             */
/*   Updated: 2025/01/13 10:11:55 by emgul            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap() : ClapTrap()
{
    ...
    std::cout << "Constructor called for [FragTrap]" << this->_name
              << std::endl;
}
...
{
    *this = src;
    std::cout << "Copy constructor called for [FragTrap]" << src._name
              << std::endl;
}
...
FragTrap &FragTrap::operator=(const FragTrap &src)
{
    ...
    std::cout << "Copy assignment operator called for [FragTrap]" << src._name
              << std::endl;
    return (*this);
}
...
void FragTrap::highFivesGuys(void)
{
    if (this->_health > 0 && this->_energy > 0)
        std::cout << this->_name
                  << " *High five* for guarding the gate like a true hero!"
                  << std::endl;
    else
