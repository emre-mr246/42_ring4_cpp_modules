...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/13 10:11:59 by emgul             #+#    #+#             */
/*   Updated: 2025/01/13 10:12:00 by emgul            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
    ...
    std::cout << "Default constructor called for [ClapTrap]" << this->_name
              << std::endl;
}
...
ClapTrap::ClapTrap(const std::string &name)
{
    ...
    this->_energy = 10;
    this->_attackDamage = 0;
    std::cout << "Constructor called for [ClapTrap]" << this->_name
              << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
    if (this->_health >= amount)
        ...
        this->_health = 0;
    std::cout << "*** -DAMAGE- *** " << this->_name << " takes " << amount
